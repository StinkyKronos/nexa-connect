    ...
    <main className="h-screen w-screen bg-[#FDD1B9] flex items-center justify-center flex-col gap-5">
      <div className="w-3/4 h-3/4 flex flex-col justify-center items-center bg-white rounded-lg px-10 py-10">
        ...
        >
          <div className="flex items-center justify-center gap-5 h-fit w-fit">
            <div className="w-fit h-fit relative">
              ...
              <label className="w-full h-full flex flex-col justify-center items-center px-20 py-3">
                <h3 className="poppins-medium w-fit select-none text-[#909090] text-2xl z-10">
                  Tenant
                </h3>
              </label>
            </div>
          ...
          <button
            className="w-full gap-2 border-['#1E2432'] border-2 px-5 py-2 rounded-md cursor-pointer flex items-center justify-center"
            onClick={handleSignInWithGoogle}
          >
            <img src="images/google-icon.svg" width={32} alt="" />
            <p className="text-black poppins-regular text-2xl">
              Sign in with Google
            </p>
          </button>
        </form>
        <div className="ml-auto">
          <p className="text-black text-2xl poppins-medium">
            The future belongs to those who{" "}
            <span className="text-[#D9650B]">believe</span> in the <br />
            <span className="text-[#D9650B]">beauty of their dreams.</span>
          </p>
          <p className="text-black w-full text-right text-lg poppins-medium">
            - Eleanor Roosevelt
          </p>
        </div>
      </div>
